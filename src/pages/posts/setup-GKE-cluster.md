...
title: GKE Cluster Setup Using gcloud CLI
description: We'll be creating a Google Cloud project, enabling the Kubernetes API, and creating a GKE cluster using only the gcloud CLI.
